...
namespace RandomNumbersAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly RandomNumbersAngularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = RandomNumbersAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(RandomNumbersAngularDbContext context)
        {
            _context = context;
        }
