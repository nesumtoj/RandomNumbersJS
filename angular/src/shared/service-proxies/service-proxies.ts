...
@Injectable()
export class MatchServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getNextAvailableMatch(): Observable<MatchDto> {
        let url_ = this.baseUrl + "/api/services/app/Match/GetNextAvailableMatch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetNextAvailableMatch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetNextAvailableMatch(<any>response_);
                } catch (e) {
                    return <Observable<MatchDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<MatchDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetNextAvailableMatch(response: HttpResponseBase): Observable<MatchDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<MatchDto>(<any>null);
    }

    /**
     * @return Success
     */
    getMatchHistory(): Observable<MatchDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Match/GetMatchHistory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMatchHistory(<any>response_);
                } catch (e) {
                    return <Observable<MatchDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetMatchHistory(response: HttpResponseBase): Observable<MatchDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getUserActiveMatch(): Observable<MatchDto> {
        let url_ = this.baseUrl + "/api/services/app/Match/GetUserActiveMatch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUserActiveMatch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUserActiveMatch(<any>response_);
                } catch (e) {
                    return <Observable<MatchDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetUserActiveMatch(response: HttpResponseBase): Observable<MatchDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    playMatch(matchId: number | null | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Match/PlayMatch?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPlayMatch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPlayMatch(<any>response_);
                } catch (e) {
    ...
    protected processPlayMatch(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class MatchDto implements IMatchDto {
    ...
    readonly winner: ParticipantDto | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).winner = _data["winner"] ? ParticipantDto.fromJS(_data["winner"]) : <any>undefined;
...
export interface IMatchDto {
    expiryDate: moment.Moment | undefined;
    participants: ParticipantDto[] | undefined;
    winner: ParticipantDto | undefined;
    lastModificationTime: moment.Moment | undefined;
    lastModifierUserId: number | undefined;
    creationTime: moment.Moment | undefined;
    creatorUserId: number | undefined;
...
export class ParticipantDto implements IParticipantDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).userFullName = _data["userFullName"];
